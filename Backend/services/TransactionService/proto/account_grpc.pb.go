...
func (c *accountServiceClient) GetAccountsByUser(ctx context.Context, in *GetAccountsByUserRequest, opts ...grpc.CallOption) (*GetAccountsByUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAccountsByUserResponse)
...
func (UnimplementedAccountServiceServer) GetAccountsByUser(context.Context, *GetAccountsByUserRequest) (*GetAccountsByUserResponse, error) {
